...
plot [610:920]  'plotdata.dat' using 1:($2>0?$2:1/0) with lines linecolor rgb 'red' title 'Binary',  'plotdata.dat' using 1:($3>0?$3:1/0) with lines linecolor rgb 'black' title 'Hybrid'
